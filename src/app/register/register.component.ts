...
export class RegisterComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private route: Router,private auth:AuthService,private router:Router,private toast:NgToastService,private api:ApiService) {
  ...
  onchange() {
    ...
    if (
      ...
      this.api.UploadImage(this.profilepic , this.registerForm.get('email')?.value)
      .subscribe({
        next:(res=>{
        console.log(res);
        }),
